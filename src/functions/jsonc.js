...
import {zip, unzip} from "./vendor/gzip";
...
JSONC.pack = function (json, bCompress) {
  ...
  return Base64.encode(String.fromCharCode.apply(String, zip(str,{level:9})));
};
/**
...
JSONC.unpack = function (gzipped, bDecompress) {
  var aArr = getArr(Base64.decode(gzipped)),
    str = String.fromCharCode.apply(String, unzip(aArr,{level:9})),
    json = JSON.parse(str);
